define([
    ...
    , function (Tibbr, Messages, Message, messageData) {
        describe("Question Messages", function () {
            ...
            describe("Attributes", function () {
                it("should have cssName", function () {
                    expect(this.messages.className).toEqual("question_messages");
                });
                ...
                it("should have current tibbr url", function () {
                    expect(this.messages.tibbrURL).toEqual({controller:"users", action:"question_messages"})
                })
            });
